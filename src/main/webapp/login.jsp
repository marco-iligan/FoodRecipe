...
<input type="hidden" id="status" value="<%= request.getAttribute("status") %>">
	...
	<div
		...
		<div
			...
			<div class="self-start hidden lg:flex flex-col  text-gray-300">
				...
				<h1 class="my-3 font-bold text-4xl text-slate-700">Welcome Back!</h1>
				<p class="pr-3 text-sm opacity-80 text-slate-600">Lorem ipsum is placeholder
		...
		<div class="flex justify-center self-center  z-10">
			<div class="p-12 bg-white mx-auto rounded-3xl w-96 ">
				<div class="mb-7">
					<h3 class="font-bold text-2xl text-slate-700">Sign In</h3>
					<p class="text-gray-400">
						Don'thave an account? <a href="register.jsp"
							class="text-sm text-amber-500 hover:text-amber-400">Sign Up</a>
					</p>
				</div>
				<form class="space-y-6" method="post" action="login">
					<div class="">
						<input
							class=" w-full text-sm  px-4 py-3 bg-gray-200 focus:bg-gray-100 border  border-gray-200 rounded-lg focus:outline-none focus:border-amber-300"
	...
	<script
		...
		if(status == "failed"){
			swal({
	            title: "Login Failed!",
	            text: "You have entered an invalid username or password. Please try again!",
	            type: "failed"
	        };
		}
	</script>
